...
class ListVerifikasiDokumenSopMutus extends ListRecords
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            ExportAction::make('export')
                ->exports([
                    ExcelExport::make('verifikasi-dokumen-sop-mutu')
                        ->fromTable(),
                ]),
    ...
    {
        return [
            // Anda bisa meletakkan widget di sini jika ingin ada di atas tab filter.
        ];
    }
